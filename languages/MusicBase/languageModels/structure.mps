...
<model ref="r:2c1687dc-3d5e-41c6-abc7-78839b701c42(MusicBase.structure)">
  ...
  <node concept="1TIwiD" id="4pw9jmIs_ze">
    ...
    <property role="R4oN_" value="musical note which can be played using MIDI" />
    <ref role="1TJDcQ" to="tpck:gw2VY9q" resolve="BaseConcept" />
    <node concept="1TJgyi" id="4pw9jmIsKVL" role="1TKVEl">
      <property role="TrG5h" value="key" />
      <ref role="AX2Wp" to="tpck:fKAQMTA" resolve="integer" />
    </node>
    <node concept="1TJgyi" id="4pw9jmIsKVN" role="1TKVEl">
      <property role="TrG5h" value="duration" />
      <ref role="AX2Wp" to="tpck:fKAQMTA" resolve="integer" />
    </node>
    <node concept="PrWs8" id="4pw9jmItZgR" role="PzmwI">
      <ref role="PrY4T" node="4pw9jmItZgQ" resolve="IPlayable" />
    </node>
  </node>
  <node concept="1TIwiD" id="4pw9jmItX0e">
    ...
    <ref role="1TJDcQ" to="tpck:gw2VY9q" resolve="BaseConcept" />
    <node concept="1TJgyj" id="4pw9jmItX0f" role="1TKVEi">
      <property role="20lmBu" value="aggregation" />
      <property role="20kJfa" value="notes" />
      <property role="20lbJX" value="0..n" />
      <ref role="20lvS9" node="4pw9jmIs_ze" resolve="Note" />
    </node>
  ...
  <node concept="PlHQZ" id="4pw9jmItZgQ">
    <property role="TrG5h" value="IPlayable" />
  </node>
</model>
